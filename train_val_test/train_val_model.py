...
def train_classifier(data_loader, model, loss_function, optimizer, global_step, args, writer):
    ...
    for index, (inputs, labels) in enumerate(process):
        ...
        process.set_description(
            'Train: acc: {:4f}, loss: {:4f}, pret: {:4f}, mask: {:4f}, PT: {:4f}, PS: {:4f}, RE: {:4f}, sim: {:4f}, batch time: {:4f}, lr: {:4f}'.format(
                acc, ls, pretext_ls, mask_loss, jigsaw_T_loss, joint_loss, reverse_loss, simloss,
        ...
        if args.mode == 'train_val':
            ...
            writer.add_scalar('pretext_ls', pretext_ls, global_step)
            ...
            writer.add_scalar('Reverse_ls', reverse_loss, global_step)
