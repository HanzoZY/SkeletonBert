...
def Statistic(shown_num, npath):
    # negative_samples = open('./work_dir/ntu60/dstanet_drop0_6090120_128/wrong_path_pre_true.txt', 'r').readlines()
    negative_samples = open(npath, 'r').readlines()
    labels = open('../prepare/ntu_60/label.txt', 'r').readlines()
...
if __name__ == '__main__':
    # Statistic(50, npath='./work_dir/ntu60/dstanet_temporalattTrueAddTCN_PEAtInput_SpatialEmbdedding_TempEncoding_2/wrong_path_pre_true.txt')
    # Statistic(50, npath='/Users/zhangyuhan/Desktop/3BK/dstanet_temporalattTrueNoTCN_PEAtInput_SpatialEmbdedding_TempEncoding_bidirection/wrong_path_pre_true.txt')
    # ConfMat(npath='./work_dir/ntu60/dstanet_temporalattTrueHead3ThenTCN_PEAtInput_SpatialEmbdedding_TempEncoding_bidirection_noEPS_150Epc/wrong_path_pre_true.txt')
    # ConfMat(npath='./work_dir/ntu60/dstanet_temporalattTrueAddTCN_PEAtInput_SpatialEmbdedding_TempEncoding_2/wrong_path_pre_true.txt')
    # ConfMat(npath='/Users/zhangyuhan/Desktop/3BK/dstanet_temporalattTrueNoTCN_PEAtInput_SpatialEmbdedding_TempEncoding_bidirection/wrong_path_pre_true.txt')
    ConfMat(
        npath='/Users/zhangyuhan/Desktop/3BK/dstanet_temporalattTrueNoTCN_PEAtInput_SpatialEmbdedding_TempEncoding_head6/wrong_path_pre_true.txt')
    # compare_samples(p_path='./work_dir/ntu60/dstanet_temporalattTrueThenTCN_PEAtInput_SpatialEmbdedding_TempEncoding_2/wrong_path_pre_true.txt',n_path='./work_dir/ntu60/dstanet_drop0_6090120_128/wrong_path_pre_true.txt',n_config='./work_dir/ntu60/dstanet_drop0_6090120_128/ntu60_dstanet.yaml')
